...
const Where = () => {
  ...
  return (
    <>
      ...
      <ThemedText className="text-xs mt-4">Current destination</ThemedText>
      <DestinationRow
        icon="MapPin"
        title="Male, Maldives"
        description="Boats & water activities"
      />
      <ThemedText className="text-xs mt-4 opacity-50">More destinations coming soon</ThemedText>
    </>
  );
};
